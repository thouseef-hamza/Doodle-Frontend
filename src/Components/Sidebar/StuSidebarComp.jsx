...
const StuSidebarComp =  React.memo(({children})=> {
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              sx={{
                ...
                px: 2.5,
                backgroundColor:
                  location.pathname === "/student/classmates"
                    ? theme.palette.primary.dark
                    : "initial",
                color:
                  location.pathname === "/student/classmates"
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              ...
              sx={{
                ...
                px: 2.5,
                backgroundColor:
                  location.pathname === "/student/classroom"
                    ? theme.palette.primary.dark
                    : "initial",
                color:
                  location.pathname === "/student/classroom"
          ...
          <ListItem disablePadding sx={{ display: "block" }}>
            <ListItemButton
              onMouseEnter={() => setOpen(true)}
              onMouseLeave={() => setOpen(false)}
              onClick={() => navigate("/student/chatroom")}
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
                px: 2.5,
                backgroundColor:
                  location.pathname === "/student/chatroom"
                    ? theme.palette.primary.dark
                    : "initial",
                color:
                  location.pathname === "/student/chatroom"
